...
So I stripped it all back - Hugo, a clean theme, and nothing else. I'd rather spend time writing than tweaking a build pipeline.

I plan to use this site to:

- Write about backend systems, infrastructure, and things I learn along the way
- Document side projects and experiments
- Occasionally write about running, photography, and travel

The old terminal UI was fun. This version is meant to be useful.
